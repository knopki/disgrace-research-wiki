...
![GPT складывает семантические и позиционные кодировки в один вектор, но крайне важно, что обычно Positional Encoding (PE) делают на базе периодических функций sin/cos разного периода для ловли вложенных периодических структур в семантике](images/01.jpg) 
...
![Позиционные вложенные кодировки образуют самоподобные семантические структуры как «глава-абзац», т.е. для ИИ текст превращается в семантический фрактал](images/02.jpg) 
...
![Позиционные кодировки: «объемное зрение» GPT и секреты AI-агентов, image #3](images/03.jpg) 

...
These are the same pipeline steps that underpin modern NLP systems and LLM tokenisation. ^[raw/articles/corpus-linguistics-wikipedia/index.md]
...
The 1-million-word limit was severe: `polite` and `sunshine` appear only 7 times in the Brown Corpus; `polite letter` once; `polite conversation` — never. ^[raw/articles/corpus-linguistics-wikipedia/index.md]
...
Wikipedia itself is increasingly used as a text corpus in academic research. ^[raw/articles/corpus-linguistics-wikipedia/index.md]

...
- **[[tot|Tree of Thoughts (ToT)]]** — the explicit, language-space realization of the System 2 / planning layer: ToT is deliberate search over a tree of thoughts with LM self-evaluation as heuristic, the algorithmic counterpart to superposition's informal BFS analogy.

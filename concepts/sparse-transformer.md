...
- **[[switch-transformer|Switch Transformer]]** — a different form of sparsity: Sparse Transformer sparsifies the *attention matrix*, Switch Transformer sparsifies the *parameter access* via MoE. The two are orthogonal and could complement each other

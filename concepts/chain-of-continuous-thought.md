...
Published at COLM 2025. Code open-sourced at facebookresearch/coconut. ^[raw/papers/2412.06769-coconut/index.md]
...
The last hidden state of the model is fed directly as the next input embedding via special boundary tokens `<bot>` and `<eot>`. ^[raw/papers/2412.06769-coconut/index.md]
...
The curriculum is **critical**: training directly in latent mode without it collapses to No-CoT-level performance (14.4% vs 34.1% on GSM8k). ^[raw/papers/2412.06769-coconut/index.md]
...
- Hao et al. (2024). *Training Large Language Models to Reason in a Continuous Latent Space.* arXiv:2412.06769. COLM 2025.
- Fedorenko et al. (2024). Language network inactivity during reasoning tasks.

...
Published at COLM 2025. Code open-sourced at facebookresearch/coconut. ^[raw/papers/2024-12-hao-coconut/index.md]
...
The last hidden state of the model is fed directly as the next input embedding via special boundary tokens `<bot>` and `<eot>`. ^[raw/papers/2024-12-hao-coconut/index.md]
...
The curriculum is **critical**: training directly in latent mode without it collapses to No-CoT-level performance (14.4% vs 34.1% on GSM8k). ^[raw/papers/2024-12-hao-coconut/index.md]
